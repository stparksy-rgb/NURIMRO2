...
# 데이터 파일 경로
# GitHub Raw URL로 직접 읽기
GITHUB = "https://raw.githubusercontent.com/stparksy-rgb/NURIMRO2/main"
DATA_FILE = f"{GITHUB}/ledger.csv"
BASE_RECEIVABLE_FILE = f"{GITHUB}/base_receivables.csv"
PRODUCTS_FILE = f"{GITHUB}/products_csv.csv"
INVENTORY_FILE = f"{GITHUB}/inventory.csv"
COMPANY_FILE = f"{GITHUB}/company_info.csv"
